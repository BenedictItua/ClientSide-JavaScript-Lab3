...
// Define the Hamburger constructor function
function Hamburger(bunType, toppings, sauces, meatType, pattyCount) {
    ...
    this.describe = function() {
        return `This hamburger has a ${this.bunType} bun, topped with ${this.toppings.join(', ')}, 
        smothered in ${this.sauces.join(', ')} sauces, containing ${this.pattyCount} ${this.meatType} patty/patties.`;
    };
}

// Create a new hamburger object
let myHamburger = new Hamburger("sesame seed", ["lettuce", "tomato", "cheese"], ["mayonnaise", "ketchup"], "beef", 2);

// Output description of the hamburger
